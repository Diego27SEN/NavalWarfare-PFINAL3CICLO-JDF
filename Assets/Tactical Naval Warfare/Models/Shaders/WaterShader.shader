Shader "Custom/WaterShader"
{
    Properties
    {
        ...
        _Amplitude1("Amplitude1", Range(0,100)) = 10
        _Frequency1("Frequency1", Range(0,1)) = 0.005
        _Speed1("Speed1", Range(0,50)) = 1
        _Direction1("Direction1 (X,Z)", Vector) = (1,0,0,0)
        _Amplitude2("Amplitude2", Range(0,100)) = 6
        _Frequency2("Frequency2", Range(0,1)) = 0.01
        _Speed2("Speed2", Range(0,50)) = 1.3
        _Direction2("Direction2 (X,Z)", Vector) = (0,1,0,0)
        _Amplitude3("Amplitude3", Range(0,100)) = 8 
        _Frequency3("Frequency3", Range(0,1)) = 0.02
