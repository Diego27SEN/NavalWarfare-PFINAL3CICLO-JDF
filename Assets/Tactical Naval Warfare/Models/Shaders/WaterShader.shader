Shader "Custom/WaterShader"
{
    Properties
    {
        ...
        _Amplitude1("Amplitude1", Range(0,100)) = 1.5
        _Frequency1("Frequency1", Range(0,1)) = 0.04
        _Speed1("Speed1", Range(0,50)) = 0.3
        _Direction1("Direction1 (X,Z)", Vector) = (1,0,0,0)
        _Amplitude2("Amplitude2", Range(0,100)) = 0.8
        _Frequency2("Frequency2", Range(0,1)) = 0.08
        _Speed2("Speed2", Range(0,50)) = 0.4
        _Direction2("Direction2 (X,Z)", Vector) = (0,1,0,0)
        _Amplitude3("Amplitude3", Range(0,100)) = 1.2
        _Frequency3("Frequency3", Range(0,1)) = 0.12
        _Speed3("Speed3", Range(0,10)) = 0.5
